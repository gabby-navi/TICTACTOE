...
public class welcomepage {
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon(welcomepage.class.getResource("/pictures/play.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(welcomepage.class.getResource("/pictures/welcomeepaage.png")));
